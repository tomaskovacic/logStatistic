        ...
        $(document).ready(function() {
            ...
            $('.form-select').change(function() {
                ...
                $( "#buttonSort" ).click(function() {
                    let from = $("#datetimeFrom").val();
                    let to = $("#datetimeTo").val();
...
<select class="form-select" style="margin-left: 30px;" aria-label="Default select example">
    ...
    From
    <input type="datetime-local" step="1" id="datetimeFrom" name="datetime">
    To
    <input type="datetime-local" step="1" id="datetimeTo" name="datetime">
    <button type="button" id="buttonSort" name="btnSort">Sort</button>
    </span>
</div>
<br><br>
